...
function runEnduranceTest(
    ...
    const initialStaminaSummary = unit.stamina.getSummary();
    const movementPhysics = unit.movement as any; // Cast since we're forcing physics system
    const initialMovementSummary = movementPhysics.getSummary();
    ...
    const finalStaminaSummary = unit.stamina.getSummary();
    const finalMovementSummary = movementPhysics.getSummary();
